...
'''
'''
a=input("enter the elements in a list seperated by comma")
...
def remove_words(list1):
    result=list(filter(lambda y :len(s)>3,list1))
    print(result)
...
'''
#12. Write a program which accepts a sequence of comma separated 
#4 digit binary numbers as its
